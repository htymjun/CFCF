  ! Constants used in KEEP2, KEEP4, KEEP6 functions
  ...
  real(8), parameter :: R_over_gamma_1 = 286.9d0
  ...
  pure function KEEP4(rho, u, v, w, uu, p, T, Normal) result(F)
  ...
  pure function KEEP6(rho, u, v, w, uu, p, T, Normal) result(F)
